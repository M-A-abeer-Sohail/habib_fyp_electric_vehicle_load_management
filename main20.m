...
xticks(linspace(1,24*nptMult,7));
    ...
    legend("1","2");
%%
ViSetting = [[4,1];[4,2];[4,3];[6,1];[6,2];[6,3];[8,1];[9,3];[11,1];[11,2]]; % Used to set the 
...
LoadStart = 16;
phaseWiseVec = [4 5 6 0 0 1 2 3 1 2 3 1 2 1 3 1 2 3 1 2 3 1 2 3 1 2 1 3]; % Used to set the loads phase wise
                                                                          % in final matrix
