...
if exist('multiplierValues.mat','var')
    ...
    residentialMuls = 5*normpdf(linspace(-0.1,0.5,nPoints),0.35,0.2) + noiseStd*5.*randn(1,nPoints);
    ...
    industrialMults = 5*normpdf(linspace(-0.7,0.5,npts),-0.1,0.3) + 5*noiseStd.*randn(1,npts);
...
reskwDaily = residentialMuls'*residentialKwLoad; % getting all 24*nptMult points for each houseLoad bus, kw
indkwDaily = industrialMults'*industrialKwFromTestCase; % getting all 24*nptMult points for each industLoad bus, kw

reskvarDaily = residentialMuls'*residentialKvarLoad; % getting all 24*nptMult points for each houseLoad bus, kvar
indkvarDaily = industrialMults'*industrialKvarFromTestCase; % getting all 24*nptMult points for each industLoad bus, kvar
...
%     kwLoopInd = industkw*industMult(i); kvarLoopInd = industkvar*industMult(i);
    ...
    industLdkw = [industLdkw; sum(tempLoadkw(1:nindustrialLoads,:), 1)];
    industLdkvar = [industLdkvar; sum(tempLoadkvar(1:nindustrialLoads,:), 1)];
    
    resLdkw = [resLdkw; sum(tempLoadkw(nindustrialLoads+1:end,:), 1)];
    resLdkvar = [resLdkvar; sum(tempLoadkvar(nindustrialLoads+1:end,:), 1)];
...
plot(ones(1,nPoints)*ratedSubkw,'linewidth',plotWidth);
hold off;
...
plot(ones(1,nPoints)*ratedDisTr634kw,'linewidth',plotWidth);
hold off;
xticks(linspace(1,24*pointsMultiplier,7));
    xticklabels({'12:00 am','04:00 am','08:00 am',...
        '12:00 pm','04:00 pm','08:00 pm','12:00 am'});
...
plot(ones(1,nPoints)*ratedDisTr652kw,'linewidth',plotWidth);
hold off;
xticks(linspace(1,24*pointsMultiplier,7));
    xticklabels({'12:00 am','04:00 am','08:00 am',...
        '12:00 pm','04:00 pm','08:00 pm','12:00 am'});
...
plot(ones(1,nPoints)*ratedDisTr611kw,'linewidth',plotWidth);
hold off;
xticks(linspace(1,24*pointsMultiplier,7));
    xticklabels({'12:00 am','04:00 am','08:00 am',...
        '12:00 pm','04:00 pm','08:00 pm','12:00 am'});
...
plot(ones(1,nPoints)*ratedDisTr675kw,'linewidth',plotWidth);
hold off;
xticks(linspace(1,24*pointsMultiplier,7));
    xticklabels({'12:00 am','04:00 am','08:00 am',...
        '12:00 pm','04:00 pm','08:00 pm','12:00 am'});
...
plot(ones(1,nPoints)*ratedDisTr646kw,'linewidth',plotWidth);
hold off;
xticks(linspace(1,24*pointsMultiplier,7));
    xticklabels({'12:00 am','04:00 am','08:00 am',...
        '12:00 pm','04:00 pm','08:00 pm','12:00 am'});
